        ...
        <div className="scorecard">
          ...
          <div className="hscore-div">
            <p className="levelinfo">
              Easy level:{" "}
              {this.easyhscore == null
                ? 0
                : parseInt(JSON.parse(this.easyhscore))}
            </p>
            <button className="resetbtn" onClick={this.handleEasyReset}>
          ...
          <div className="hscore-div">
            <p className="levelinfo">
              Medium level:{" "}
              {this.mediumhscore == null
                ? 0
                : parseInt(JSON.parse(this.mediumhscore))}
            </p>
            <button className="resetbtn" onClick={this.handleMediumReset}>
              Reset this highscore
            </button>
          </div>
          <div className="hscore-div">
            <p className="levelinfo">
              Hard level:{" "}
              {this.hardhscore == null
                ? 0
                : parseInt(JSON.parse(this.hardhscore))}
            </p>
            <button className="resetbtn" onClick={this.handleHardReset}>
              Reset this highscore
            </button>
          </div>
          <div className="resetall">
            <button className="resetallbtn" onClick={this.handleAllReset}>
